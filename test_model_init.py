"""
test_model_init.py
Created: 2026-01-01T12:05:00+09:00
Independently test LegalAdvisorModel initialization with OpenAI.
"""
import os
import sys
...
def test_init():
    load_dotenv()
    print("Starting LegalAdvisorModel (OpenAI) initialization test...")
    ...
    try:
        ...
        print("Testing full advice generation (this will call OpenAI API)...")
